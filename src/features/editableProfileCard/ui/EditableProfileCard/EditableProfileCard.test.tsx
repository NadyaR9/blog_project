...
describe('feature/EditableProfileCard', () => {
  ...
  test('cancel profile edit, return initial value', async () => {
    ...
    await userEvent.type(
      screen.getByTestId('EditableProfileCard.firstname'),
      'name',
    );
    await userEvent.type(
      screen.getByTestId('EditableProfileCard.lastname'),
      'name',
    );
    expect(screen.getByTestId('EditableProfileCard.firstname')).toHaveValue(
      'name',
    );
    expect(screen.getByTestId('EditableProfileCard.lastname')).toHaveValue(
      'name',
    );
    await userEvent.click(
      screen.getByTestId('EditableProfileCardHeader.CancelButton'),
